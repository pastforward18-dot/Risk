...
st.caption("iPad · Safari 안정화 버전 / Plotly 제거 / 실제수량 자동비중 / Sharpe / Risk Parity / 상관계수")
...
default = pd.DataFrame([
    ...
    {"ticker":"CASH_KRW","name":"현금","market":"CASH","quantity":0.0,"manual_weight":0.0},
])
